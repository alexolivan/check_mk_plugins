...
customers = (
    {'host': '192.168.210.105', 'port': '8130', 'mountpoint':'malagafmmobile', 'adminuser': 'admin', 'adminpass': 'MARCAMALAGApass1'},
    {'host': '192.168.210.108', 'port': '8130', 'mountpoint':'malagafmmobile', 'adminuser': 'admin', 'adminpass': 'MARCAMALAGApass1'},
	)
...
def downloadStatsfiles():
    for d in customers:
        ...
        filename = "/tmp/icecast-%s-%s" % (d['host'], d['port'])
